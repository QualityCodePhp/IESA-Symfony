...
class ProductOrderController extends Controller
{
    ...
    {
        return $this->render('product_order/index.html.twig', ['product_orders' => $productOrderRepository->findAll()]);
    }
    ...
    {
        return $this->render('product_order/show.html.twig', ['product_order' => $productOrder]);
    }
    ...
    public function edit(Request $request, ProductOrder $productOrder): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            return $this->redirectToRoute('product_order_edit', ['id' => $productOrder->getId()]);
        }
